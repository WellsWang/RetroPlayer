...
int AudioGeneratorMOD::GetChannelNumber()
{
    return Mod.numberOfChannels;
}
      
int AudioGeneratorMOD::GetSongLength()
{
    return Mod.songLength * ROWS;
}

int AudioGeneratorMOD::GetPatternNumber()
{
    return Mod.numberOfPatterns;
}

int AudioGeneratorMOD::GetPlayPos()
{
    return Player.orderIndex * ROWS + Player.row;
}

bool AudioGeneratorMOD::GetSkipJump()
{
    return skipJump;
}

int AudioGeneratorMOD::GetChannelVolume(uint8_t channel)
{
    return Mixer.channelVolume[channel];
}

int AudioGeneratorMOD::GetChannelFreq(uint8_t channel)
{
    return Mixer.channelFrequency[channel];
}

char* AudioGeneratorMOD::GetFileDescription()
{
  return description;
}